/*
  ...
  - Changed the type of `authorId` on the `Dream` table. No cast exists, the column would be dropped and recreated, which cannot be done if there is data, since the column is required.
...
-- DropForeignKey
ALTER TABLE "Dream" DROP CONSTRAINT "Dream_authorId_fkey";
